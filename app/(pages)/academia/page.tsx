        ...
        <div>
            ...
            <section className="mb-8 py-16" id="mathematics">
                ...
                <div className="max-w-xs mx-auto grid gap-6 lg:grid-cols-3 items-start lg:max-w-7xl">
                    <SubjectCard title="Specialist Mathematics" unit="34">Mainly taught by Joel Cheok and Jerry Jin. Also suitable for advanced Unit 1/2 students.</SubjectCard>
                    <SubjectCard title="Mathematical Methods" unit="34">Taught by Joel Cheok, Jerry Jin and Chris Lu. Also suitable for advanced Unit 1/2 students.</SubjectCard>
                </div>
            </section>
            <section className="mb-8 py-16" id="science">
                ...
                <div className="max-w-xs mx-auto grid gap-6 lg:grid-cols-3 items-start lg:max-w-7xl">
                    <SubjectCard title="VCE Biology" unit="34">Taught by Joel Cheok (International Biology Olympiad Silver Medallist, RAW 50).</SubjectCard>
                    <SubjectCard title="VCE Chemistry" unit="34">Taught by Jerry Jin and Joel Cheok. Also suitable for advanced Unit 1/2 students.</SubjectCard>
                    <SubjectCard title="VCE Physics" unit="34">Taught by Joel Cheok and Jerry Jin. Also suitable for advanced Unit 1/2 students.</SubjectCard>
