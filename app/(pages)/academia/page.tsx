        ...
        <div>
            ...
            <section>
                <div className="flex flex-col justify-center items-center text-2xl font-medium tracking-tighter">
                    <p className="mb-4 w-[80vw] md:w-[60vw] 3xl:w-[72rem]">We offer a <C>wide</C> variety of subjects, so that you can have the most <C>consistent</C> experience across all your studies.</p>
                    ...
                    <p className="mb-4 w-[80vw] md:w-[60vw] 3xl:w-[72rem]">We are starting the week <C>beginning</C> the 13th of January, and hope to wrap up content around the winter holidays, so you can <C>efficiently</C> learn all the content whilst saving time to <C>savour</C> all the fun Year 12 has to bring.</p>
                </div>
            </section>
